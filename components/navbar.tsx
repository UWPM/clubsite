...
export default function Navbar() {
  ...
  return (
    <nav className="border">
      ...
      <div className="fixed bottom-12 left-1/2 z-10 mx-auto -translate-x-1/2 rounded-full bg-secondary/60 shadow-lg backdrop-blur-xs transition duration-300 ease-in-out hover:border-accent-foreground">
